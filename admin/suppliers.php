                                ...
                                <tr>
                                    ...
                                    <td class="form-cell">
                                        <form method="POST">
                                            ...
                                            <button type="submit" name="remove_ingredient_from_supplier" class="action-btn btn-delete" onclick="return confirm('Remove this ingredient from this supplier?');">Remove</button>
                                        </form>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
