...
<div class="container">
    ...
    <div class="main">
        ...
        <!-- Bottom Section: My Sales -->
        <div class="panel">
            <h2>My Sales for <?php echo date('d M Y', strtotime($selected_date)); ?></h2>
            <table>
                <thead>
                    <tr>
                        <th>Sale ID</th>
                ...
                <tbody>
                    ...
                    ");
                    $sales_stmt->bind_param("si", $selected_date, $user_id);
                    $sales_stmt->execute();
                    ...
                    if (empty($selected_date_sales)): ?>
                        <tr><td colspan="3">No sales recorded for this date.</td></tr>
                    <?php else: ?>
